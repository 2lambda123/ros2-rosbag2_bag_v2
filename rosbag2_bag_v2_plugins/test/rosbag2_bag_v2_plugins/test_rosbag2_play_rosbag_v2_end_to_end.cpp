...
TEST_F(PlayEndToEndTestFixture,
  ...
  auto string_messages =
      sub_->get_received_messages<std_msgs::msg::String>("/string_topic");
  auto int_messages =
      sub_->get_received_messages<std_msgs::msg::Int32>("/int_topic");
...
TEST_F(PlayEndToEndTestFixture,
  ...
  auto exit_code = execute_and_wait_until_completion(
      "ros2 bag play test_bag.bag", database_path_);
